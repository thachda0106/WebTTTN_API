	...
	if (customer) {
		...
		try {
			await sendEmail(
				email,
				'ĐẶT LẠI MẬT KHẨU',
				`<b>Để đặt mật khẩu vui lòng click vào đường dẫn dưới. Link có hiệu lực trong 5 phút! <b><br/><a href = "http://localhost:8111/api/v1/account/update-password/${customer.username}/${Date.now()}">Reset password!</a>`
			);
